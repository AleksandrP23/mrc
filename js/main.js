...
if (document.querySelector('.contact')) {
  let center = [56.32393206840367, 43.95299449999996];
  function init() {
...
const swipersOffice = document.querySelector('.office-slider__wrap');
if (swipersOffice) {
  const swiperOffice = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersOffice, {
    slidesPerView: 3,
    spaceBetween: 40,
    scrollbar: {
      el: ".office-slider__scrollbar",
      hide: true
    },
    navigation: {
      nextEl: '.office-slider__next',
      prevEl: '.office-slider__prev'
    },
    breakpoints: {
